...
def drawCustomSceneGraphNode(node, pipeline, transformName, parentTransform=tr.identity()):
    ...
    # so this draw function is called recursively
        ...
        for child in node.childs:
            drawCustomSceneGraphNode(child, pipeline, transformName, newTransform)
